...
@Declaration(fieldSize = 12, name = "SV1")
public class SV1  extends gov.delaware.edi.x12.Segment {
    // As per 837 FOCUS
	public SV1() { super(); }
    public SV1(String content) {
    	super(content);
/*		this.put("productOrServiceID", elements[1]);
	...
	public SV1(String productOrServiceID, String compositeMedicalProcedureIdentifier, String lineItemChargeAmount,
