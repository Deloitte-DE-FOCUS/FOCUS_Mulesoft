...
---
{
	...
	"Assessment_Title__c": flowVars.inputData.AssessmentType,
	...
	"Assessment_Type__c": flowVars.inputData.AssessmentTitle,
	...
	"Trauma_Risk_Level__c" : flowVars.inputData.Properties.TRAUMA_RISK_LEVEL default "",
	"Trauma_Score__c" : flowVars.inputData.Properties.TRAUMA_SCORE default "",
	...
	"Question_17_Additional_Answers__c" : (flowVars.inputData.QuestionResponses["Education"][2].Responses[1] default []) filter ( ["Private Academic", "Public Academic","Vocational (Certificate)","Vocational (Non-certificate)","Charter","Alternative","Independent Study","Credit Recovery","Home school","High School Diploma Program","GED Program"]  contains $.Response ) map $.Response joinBy ";" ,
	...
	"Question_20_Additional_Answers__c" : ((payload.Question_20_Additional_Answers__c default "") joinBy ";"),
	...
	"Question_21_Date_of_Last_IEP__c" : (payload."Question_21_Date_of_Last_IEP__c"[0]  as :date  {format: "MM/dd/yyyy"} as :date {format: "yyyy-MM-dd"}  ) default "",//as :date {format : "yyyyMMdd"} as :string {format: "yyyy-MM-dd"}
	...
	"Question_33_Additional_Answers__c" : (("Current employment is going well;" when (flowVars.inputData.QuestionResponses["Employment"][0].Responses map $.Response contains "Current employment is going well") otherwise "") default "" ++ 
	("Having problems with current employment;" when (flowVars.inputData.QuestionResponses["Employment"][0].Responses map $.Response contains "Having problems with current employment") otherwise "") ++ 
	("Too young for employment consideration (generally 15 years old or younger);" when (flowVars.inputData.QuestionResponses["Employment"][0].Responses map $.Response contains "Too young for employment consideration (generally 13 years old or younger)") otherwise "") ++
	...
	"Q36_History_of_employment_performance__c" : ("Youth has never been employed;" when (flowVars.inputData.QuestionResponses["Employment"][3].Responses map $.Response contains "Youth has never been employed") otherwise "") ++
	("Has been successfully employed;" when (flowVars.inputData.QuestionResponses["Employment"][3].Responses map $.Response contains "Has been successfully employed") otherwise "") ++
	("Fired;" when (flowVars.inputData.QuestionResponses["Employment"][3].Responses map $.Response contains "Fired") otherwise "") ++
	("Quit;" when (flowVars.inputData.QuestionResponses["Employment"][3].Responses map $.Response contains "Quit") otherwise "") ,
	...
	when (flowVars.inputData.QuestionResponses["Relationships"][4].Question == "Current prosocial community ties:") otherwise "",
	...
	"Q50_History_of_DFS_involvement__c" : (("No dependency, abuse, or neglect investigation history;" when (flowVars.inputData.QuestionResponses["Family & Social Support"][4].Responses map $.Response contains "No dependency, abuse, or neglect investigation history") otherwise "" ) ++
		("Unsubstantiated investigation(s)/no dependency petition filed;" when (flowVars.inputData.QuestionResponses["Family & Social Support"][4].Responses map $.Response contains "Unsubstantiated investigation(s)/no dependency petition filed") otherwise "" ) ++
		("Substantiated investigation(s)/no dependency petition filed;" when (flowVars.inputData.QuestionResponses["Family & Social Support"][4].Responses map $.Response contains "Substantiated investigation(s)/no dependency petition filed") otherwise "" ) ++
		("Dependency petition filed" when (flowVars.inputData.QuestionResponses["Family & Social Support"][4].Responses map $.Response contains "Dependency petition filed") otherwise "" ) ),
	"Question_50_Additional_Answers__c" : ("Resulted in out-of-home placement" when (flowVars.inputData.QuestionResponses["Family & Social Support"][4].Responses map $.Response contains "Resulted in out-of-home placement") otherwise "") ,
	...
	"Question_52_Additional_Answers__c" : (("Living alone without support;" when (flowVars.inputData.QuestionResponses["Family & Social Support"][6].Responses map $.Response contains "Living alone without support") otherwise "") ++
		("Living alone with support from family or others;" when (flowVars.inputData.QuestionResponses["Family & Social Support"][6].Responses map $.Response contains "Living alone with support from family or others") otherwise "") ++
		("Biological/Non-biological mother;" when (flowVars.inputData.QuestionResponses["Family & Social Support"][6].Responses map $.Response contains "Biological/Non-biological mother") otherwise "") ++
	...
	"Q55_Imprisonment_history_household__c" : (("No jail/imprisonment history in household;" when (flowVars.inputData.QuestionResponses["Family & Social Support"][9].Responses map $.Response contains "No jail/imprisonment history in household") otherwise "") ++  
	...
	"Q56_Imprisonment_history_household_3mos__c" : (("No jail/imprisonment history in household;" when (flowVars.inputData.QuestionResponses["Family & Social Support"][10].Responses map $.Response contains "No jail/imprisonment history in household") otherwise "") ++  
	...
	"Q66_Annual_income_of_youth_family__c" : "Unknown" when (flowVars.inputData.QuestionResponses["Family & Social Support"][20].Responses[0].Response == "Unknown") otherwise 
	flowVars.inputData.QuestionResponses["Family & Social Support"][20].Responses[2].Response,
	"Question_66_Additional_Answers__c" : (flowVars.inputData.QuestionResponses["Family & Social Support"][20].Responses filter ($.Label == "Number of persons in household") map $.Response)[0], 
	"Question_66_Annual_Income__c" : (flowVars.inputData.QuestionResponses["Family & Social Support"][20].Responses filter ($.Label == "Annual income") map $.Response)[0],
	...
	"Q70_History_of_Drug_Alcohol_Use__c" : ((flowVars.inputData.QuestionResponses["Substance Abuse"][0].Responses[0].Response default "")  ) 
	when (flowVars.inputData.QuestionResponses["Substance Abuse"][0].Question == "History of drug & alcohol use:") otherwise "",
	"Question_70_Additional_Answers__c" :  (("Alcohol;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][0].Responses map $.Response contains "Alcohol") otherwise "") ++
	("Drug;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][0].Responses map $.Response contains "Drug") otherwise "") ++
	("Youth’s history of alcohol use not considered to be a problem;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][0].Responses map $.Response contains "Youth’s history of alcohol use not considered to be a problem") otherwise "") ++
	("Youth’s history of drug use not considered to be a problem;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][0].Responses map $.Response contains "Youth’s history of drug use not considered to be a problem") otherwise "")),
	"Q71_History_of_Drug_Alcohol_Use__c" : ((flowVars.inputData.QuestionResponses["Substance Abuse"][1].Responses[0].Response default "") ++ ";" ++ (flowVars.inputData.QuestionResponses["Substance Abuse"][1].Responses[1].Response default "") ++ ";" ++  (flowVars.inputData.QuestionResponses["Substance Abuse"][1].Responses[2].Response default "") ++ ";" ++ (flowVars.inputData.QuestionResponses["Substance Abuse"][1].Responses[3].Response default "") ) 
	when (flowVars.inputData.QuestionResponses["Substance Abuse"][1].Question == "History of drug & alcohol use:") otherwise "",
	"Question_71_Additional_Answers__c" : (("Alcohol;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][1].Responses map $.Response contains "Alcohol") otherwise "") ++
	("Drug;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][1].Responses map $.Response contains "Drug") otherwise "")),
	...
	"Question_72_Additional_Answers__c" : (("Past alcohol use within the spectrum of typical adolescent behavior and not considered to be a problem;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][2].Responses map $.Response contains "Past alcohol use within the spectrum of typical adolescent behavior and not considered to be a problem") otherwise "") ++ 
		("Alcohol disrupted education;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][2].Responses map $.Response contains "Alcohol disrupted education") otherwise "") ++ 
		("Alcohol caused family conflict;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][2].Responses map $.Response contains "Alcohol caused family conflict") otherwise "") ++ 
		("Alcohol interfered with keeping pro-social friends;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][2].Responses map $.Response contains "Alcohol interfered with keeping pro-social friends") otherwise "") ++ 
		("Alcohol caused health problems;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][2].Responses map $.Response contains "Alcohol caused health problems") otherwise "") ++ 
		("Alcohol contributed to delinquent behavior;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][2].Responses map $.Response contains "Alcohol contributed to delinquent behavior") otherwise "") ++ 
		("Youth needs increased amounts of Alcohol to achieve same level of intoxication or high;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][2].Responses map $.Response contains "Youth needed increasing amounts of Alcohol to achieve same level of intoxication or high") otherwise "") ++ 
		("Youth experienced withdrawal symptoms;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][2].Responses map $.Response contains "Youth experienced withdrawal symptoms") otherwise "") ++
		("Other;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][2].Responses map $.Response contains "Other") otherwise "") ),
	"Question_72_Describe__c" : payload."Question_72_Describe__c"[0],
	"Q80_Youth_s_drug_use__c" : flowVars.inputData.QuestionResponses["Substance Abuse"][10].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Substance Abuse"][10].Question == "Youth's current drug use: ") otherwise "",
	"Question_80_Additional_Answers__c" : (("Current drug use within the spectrum of typical adolescent behavior and not considered to be a problem;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][10].Responses map $.Response contains "Current drug use within the spectrum of typical adolescent behavior and not considered to be a problem") otherwise "") ++ 
		("Drugs disrupting education;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][10].Responses map $.Response contains "Drugs disrupting education") otherwise "") ++ 
		("Drugs causing family conflict;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][10].Responses map $.Response contains "Drugs causing family conflict") otherwise "") ++ 
		("Drugs interfering with keeping pro-social friends;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][10].Responses map $.Response contains "Drugs interfering with keeping pro-social friends") otherwise "") ++ 
		("Drugs causing health problems;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][10].Responses map $.Response contains "Drugs causing health problems") otherwise "") ++ 
		("Drugs contributing to delinquent behavior;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][10].Responses map $.Response contains "Drugs contributing to delinquent behavior") otherwise "") ++ 
		("Youth needs increasing amounts of drugs to achieve same level of intoxication or high;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][10].Responses map $.Response contains "Youth needs increasing amounts of drugs to achieve same level of intoxication or high") otherwise "") ++ 
		("Youth experiences withdrawal symptoms;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][10].Responses map $.Response contains "Youth experiences withdrawal symptoms") otherwise "") ++
		("Other;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][10].Responses map $.Response contains "Other") otherwise "") ),
	"Question_80_Describe__c" : payload."Question_80_Describe__c"[0],
	"Q79_Indication_of_current_use_of_alcohol__c" : flowVars.inputData.QuestionResponses["Substance Abuse"][9].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Substance Abuse"][9].Question == "Indication of current use of alcohol:") otherwise "",
	"Question_79_Additional_Answers__c" : (("Alcohol use recently detected by UA;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][9].Responses map $.Response contains "Alcohol use recently detected by UA") otherwise "") ++ 
		("Alcohol use recently detected by UA after being in community;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][9].Responses map $.Response contains "Alcohol use recently detected by UA after being in community") otherwise "") ++ 
		("Alcohol causing family conflict;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][9].Responses map $.Response contains "Alcohol causing family conflict") otherwise "") ++ 
		("Alcohol interfering with keeping pro-social friends;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][9].Responses map $.Response contains "Alcohol interfering with keeping pro-social friends") otherwise "") ++ 
		("Alcohol causing health problems;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][9].Responses map $.Response contains "Alcohol causing health problems") otherwise "") ++ 
		("Alcohol contributing to delinquent behavior;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][9].Responses map $.Response contains "Alcohol contributing to delinquent behavior") otherwise "") ++ 
		("Youth needs increasing amounts of Alcohol to achieve same level of intoxication or high;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][9].Responses map $.Response contains "Youth needs increasing amounts of Alcohol to achieve same level of intoxication or high") otherwise "") ++ 
		("Youth experiences withdrawal symptoms;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][9].Responses map $.Response contains "Youth experiences withdrawal symptoms") otherwise "") ++
		("Other;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][9].Responses map $.Response contains "Other") otherwise "") ),
	Question_79_Describe__c : payload."Question_79_Describe__c"[0],
	"Q82_Types_of_drugs_currently_used__c" : (("No current use of drugs;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][12].Responses map $.Response contains "No current use of drugs") otherwise "" ) ++ 
		("Currently using drugs;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][12].Responses map $.Response contains "Currently using drugs") otherwise "" )  ),
	"Question_82_Additional_Answers__c" : (("Marijuana/Hashish;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][12].Responses map $.Response contains "Marijuana/Hashish") otherwise "" ) ++
		("Inhalants (Glue/Gasoline);" when (flowVars.inputData.QuestionResponses["Substance Abuse"][12].Responses map $.Response contains "Inhalants (Glue/Gasoline)") otherwise "" ) ++ 
		("Cocaine (Crack/Rock);" when (flowVars.inputData.QuestionResponses["Substance Abuse"][12].Responses map $.Response contains "Cocaine (Crack/Rock)") otherwise "" ) ++  
		("Cocaine (Coke);" when (flowVars.inputData.QuestionResponses["Substance Abuse"][12].Responses map $.Response contains "Cocaine (Coke)") otherwise "" ) ++ 
		("Amphetamines (Meth/Uppers/Speed);" when (flowVars.inputData.QuestionResponses["Substance Abuse"][12].Responses map $.Response contains "Amphetamines (Meth/Uppers/Speed)") otherwise "" ) ++  
		("Ecstasy;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][12].Responses map $.Response contains "Ecstasy") otherwise "" ) ++ 
		("Barbiturates (Tuinal/Seconal/Downers);" when (flowVars.inputData.QuestionResponses["Substance Abuse"][12].Responses map $.Response contains "Barbiturates (Tuinal/Seconal/Downers)") otherwise "" ) ++
		("Tranquilizers/Sedatives (Valium/Librium/Dalmane/Ketamine);" when (flowVars.inputData.QuestionResponses["Substance Abuse"][12].Responses map $.Response contains "Tranquilizers/Sedatives (Valium/Librium/Dalmane/Ketamine)") otherwise "" ) ++  
		("Hallucinogens (LSD/Acid/Mushrooms/GHB);" when (flowVars.inputData.QuestionResponses["Substance Abuse"][12].Responses map $.Response contains "Hallucinogens (LSD/Acid/Mushrooms/GHB)") otherwise "" ) ++  
		("Phencyclidine (PCP/Angel Dust);" when (flowVars.inputData.QuestionResponses["Substance Abuse"][12].Responses map $.Response contains "Phencyclidine (PCP/Angel Dust)") otherwise "" ) ++ 
		("Heroin;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][12].Responses map $.Response contains "Heroin") otherwise "" ) ++ 
		("Other opiates (Dilaudid/Demerol/Percodan/Codeine/Oxycontin);" when (flowVars.inputData.QuestionResponses["Substance Abuse"][12].Responses map $.Response contains "Other opiates (Dilaudid/Demerol/Percodan/Codeine/Oxycontin)") otherwise "" ) ++ 
		("OTCs (Cough Syrup, Sudafed, etc);" when (flowVars.inputData.QuestionResponses["Substance Abuse"][12].Responses map $.Response contains "OTCs (Cough Syrup, Sudafed, etc)") otherwise "" ) ++ 
		("Prescription medication(s) not prescribed to youth;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][12].Responses map $.Response contains "Prescription medication(s) not prescribed to youth") otherwise "" ) ++ 
		("Prescription medication(s) prescribed to youth;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][12].Responses map $.Response contains "Prescription medication(s) prescribed to youth") otherwise "" ) ++ 
		("Other drugs" when (flowVars.inputData.QuestionResponses["Substance Abuse"][12].Responses map $.Response contains "Other drugs") otherwise "" )),
	...
	"Question_82_Describe__c" : (payload."Question_82_Describe__c"[0] default "") ++ ";" ++ (payload."Question_82_Describe__c"[1] default "") ++ ";"  ++ (payload."Question_82_Describe__c"[3] default ""),
	...
	"Q73_History_of_youth_s_drug_use__c" : flowVars.inputData.QuestionResponses["Substance Abuse"][3].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Substance Abuse"][3].Question == "History of youth's drug use: ") otherwise "",
	"Question_73_Additional_Answers__c" : (("Past drug use within the spectrum of typical adolescent behavior and not considered to be a problem;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][3].Responses map $.Response contains "Past drug use within the spectrum of typical adolescent behavior and not considered to be a problem") otherwise "") ++ 
		("Drugs disrupted education;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][3].Responses map $.Response contains "Drugs disrupted education") otherwise "") ++ 
		("Drugs caused family conflict;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][3].Responses map $.Response contains "Drug caused family conflict") otherwise "") ++ 
		("Drugs interfered with keeping pro-social friends;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][3].Responses map $.Response contains "Drug interfered with keeping pro-social friends") otherwise "") ++ 
		("Drugs caused health problems;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][3].Responses map $.Response contains "Drugs caused health problems") otherwise "") ++ 
		("Drugs contributed to delinquent behavior;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][3].Responses map $.Response contains "Drugs contributed to delinquent behavior") otherwise "") ++ 
		("Youth needed increasing amounts of Drugs to achieve same level of intoxication or high;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][3].Responses map $.Response contains "Youth needed increasing amounts of Drugs to achieve same level of intoxication or high") otherwise "") ++ 
		("Youth experienced withdrawal symptoms;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][3].Responses map $.Response contains "Youth experienced withdrawal symptoms") otherwise "") ++
		("Other;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][3].Responses map $.Response contains "Other") otherwise "") ),
	"Question_73_Describe__c" : payload."Question_73_Describe__c"[0] default "",
	"Q74_History_of_referrals_SA_assessment__c" : flowVars.inputData.QuestionResponses["Substance Abuse"][4].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Substance Abuse"][4].Question == "History of referrals for drug/alcohol assessment:") otherwise "",
	"Q75_History_attending_SA_education_class__c" : flowVars.inputData.QuestionResponses["Substance Abuse"][5].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Substance Abuse"][5].Question == "History of attending drug/alcohol education classes for a drug/alcohol problem:") otherwise "",
	"Q76_History_participating_in_SA_program__c" : flowVars.inputData.QuestionResponses["Substance Abuse"][6].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Substance Abuse"][6].Question == "History of participating in drug/alcohol treatment program:") otherwise "",
	"Q77_History_of_residential_SA_treatment__c" : ((flowVars.inputData.QuestionResponses["Substance Abuse"][7].Responses[0].Response default "") ++ ";" ++ (flowVars.inputData.QuestionResponses["Substance Abuse"][7].Responses[1].Response default "") ++ ";" ++ (flowVars.inputData.QuestionResponses["Substance Abuse"][7].Responses[2].Response default ""))
	when (flowVars.inputData.QuestionResponses["Substance Abuse"][7].Question == "History of participation in residential drug/alcohol treatment: ") otherwise "",
	"Q78_Youth_s_current_alcohol_use__c" : ((flowVars.inputData.QuestionResponses["Substance Abuse"][8].Responses[0].Response default "") ) 
	when (flowVars.inputData.QuestionResponses["Substance Abuse"][8].Question == "Youth's current alcohol use: ") otherwise "",
	"Question_78_Additional_Answers__c" : (("Current alchohol use within the spectrum of typical adolescent behavior and not considered to be a problem;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][8].Responses map $.Response contains "Current alchohol use within the spectrum of typical adolescent behavior and not considered to be a problem") otherwise "") ++ 
		("Alcohol disrupting education;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][8].Responses map $.Response contains "Alcohol disrupting education") otherwise "") ++ 
		("Alcohol causing family conflict;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][8].Responses map $.Response contains "Alcohol causing family conflict") otherwise "") ++ 
		("Alcohol interfering with keeping pro-social friends;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][8].Responses map $.Response contains "Alcohol interfering with keeping pro-social friends") otherwise "") ++ 
		("Alcohol causing health problems;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][8].Responses map $.Response contains "Alcohol causing health problems") otherwise "") ++ 
		("Alcohol contributing to delinquent behavior;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][8].Responses map $.Response contains "Alcohol contributing to delinquent behavior") otherwise "") ++ 
		("Youth needs increasing amounts of Alcohol to achieve same level of intoxication or high;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][8].Responses map $.Response contains "Youth needs increasing amounts of Alcohol to achieve same level of intoxication or high") otherwise "") ++ 
		("Youth experiences withdrawal symptoms;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][8].Responses map $.Response contains "Youth experiences withdrawal symptoms") otherwise "") ++
		("Other;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][8].Responses map $.Response contains "Other") otherwise "") ),
	"Question_78_Describe__c" : payload."Question_78_Describe__c"[0],
	"Q81_Indication_of_current_drug_use__c" : flowVars.inputData.QuestionResponses["Substance Abuse"][11].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Substance Abuse"][11].Question == "Indication of current drug use:") otherwise "",
	"Question_81_Additional_Answers__c" : (("Drug use recently detected by UA;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][11].Responses map $.Response contains "Drug use recently detected by UA") otherwise "") ++ 
		("Drug use recently detected by UA after being in community;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][11].Responses map $.Response contains "Drug use recently detected by UA after being in community") otherwise "") ++ 
		("Drug use causing family conflict;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][11].Responses map $.Response contains "Drug use causing family conflict") otherwise "") ++ 
		("Drug use interfering with keeping pro-social friends;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][11].Responses map $.Response contains "Drug use interfering with keeping pro-social friends") otherwise "") ++ 
		("Drug use causing health problems;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][11].Responses map $.Response contains "Drug use causing health problems") otherwise "") ++ 
		("Drug use contributing to delinquent behavior;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][11].Responses map $.Response contains "Drug use contributing to delinquent behavior") otherwise "") ++ 
		("Youth needs increasing amounts of Drugs to achieve same level of intoxication or high;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][11].Responses map $.Response contains "Youth needs increasing amounts of Drugs to achieve same level of intoxication or high") otherwise "") ++ 
		("Youth experiences withdrawal symptoms;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][11].Responses map $.Response contains "Youth experiences withdrawal symptoms") otherwise "") ++
		("Other;" when (flowVars.inputData.QuestionResponses["Substance Abuse"][11].Responses map $.Response contains "Other") otherwise "") ),
	"Question_81_Describe__c" : payload."Question_81_Describe__c"[0],
	"Q84_Status_of_SA_goals__c" : flowVars.inputData.QuestionResponses["Substance Abuse"][14].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Substance Abuse"][14].Question == "Status of substance abuse goals:") otherwise "",
	"Q83_SA_treatment_program_participation__c" : ((flowVars.inputData.QuestionResponses["Substance Abuse"][13].Responses[0].Response default "") ++ ";" ++ (flowVars.inputData.QuestionResponses["Substance Abuse"][13].Responses[1].Response default "") ++ ";" ++ (flowVars.inputData.QuestionResponses["Substance Abuse"][13].Responses[2].Response default "") ++ ";" ++ (flowVars.inputData.QuestionResponses["Substance Abuse"][13].Responses[3].Response default "") ++ ";" ++ (flowVars.inputData.QuestionResponses["Substance Abuse"][13].Responses[4].Response default "") ++ ";" ++ (flowVars.inputData.QuestionResponses["Substance Abuse"][13].Responses[5].Response default "") ++ ";" ++ (flowVars.inputData.QuestionResponses["Substance Abuse"][13].Responses[6].Response default ""))  
	when (flowVars.inputData.QuestionResponses["Substance Abuse"][13].Question == "Current drug/alcohol treatment program participation:") otherwise "",
	"Q94_Current_suicidal_ideation__c" : (("Does not currently have serious thoughts about suicide;" when (flowVars.inputData.QuestionResponses["Mental Health"][9].Responses map $.Response contains ("Does not currently have serious thoughts about suicide") ) otherwise "") ++ 
		 ("Feels life is not worth living - no hope for future;" when (flowVars.inputData.QuestionResponses["Mental Health"][9].Responses map $.Response contains ("Feels life is not worth living - no hope for future")) otherwise "") ++ 
		 ("Has serious thoughts about suicide;" when (flowVars.inputData.QuestionResponses["Mental Health"][9].Responses map $.Response contains ("Has serious thoughts about suicide")) otherwise "" ) ++ 
		 ("Knew someone well who has committed suicide;" when (flowVars.inputData.QuestionResponses["Mental Health"][9].Responses map $.Response contains ("Knew someone well who has committed suicide")) otherwise "") ++ 
		 ("Has made a plan to commit suicide;" when (flowVars.inputData.QuestionResponses["Mental Health"][9].Responses map $.Response contains ("Has made a plan to commit suicide")) otherwise "") ++ 
		 ("Engages in self-mutilating behavior;" when (flowVars.inputData.QuestionResponses["Mental Health"][9].Responses map $.Response contains ("Engages in self-mutilating behavior")) otherwise "") ++
		 ("No history of mental health concern(s);" when (flowVars.inputData.QuestionResponses["Mental Health"][9].Responses map $.Response contains ("No history of mental health concern(s)")) otherwise "") ++ 
		 ("Has recently attempted to commit suicide" when (flowVars.inputData.QuestionResponses["Mental Health"][9].Responses map $.Response contains ("Has recently attempted to commit suicide")) otherwise "" )) ,
	"Question_94_Additional_Answers__c" : (payload.Question_94_Additional_Answers__c[0] default "") ++ ";" ++ (payload.Question_94_Additional_Answers__c[1] default "") ++ ";" ++ (payload.Question_94_Additional_Answers__c[2] default "") ++ ";" ++ (payload.Question_94_Additional_Answers__c[3] default ""),
	//"Question_94_Known_Person_Suicide_Date__c" : (((payload.Question_94_Known_Person_Suicide_Date__c[0] ++ |05:00|) as :date {format : "yyyy-MM-dd"} ) default ""),
	//"Question_94_Attempted_Suicide_Date__c" : (((payload."Question_94_Attempted_Suicide_Date__c"[0] ++ |05:00|)  as :date {format : "yyyy-MM-dd"} ) default "" ),
	"Q86_History_of_suicidal_ideation__c" : (("Has never had serious thoughts about suicide;" when (flowVars.inputData.QuestionResponses["Mental Health"][1].Responses map $.Response contains ("Has never had serious thoughts about suicide") ) otherwise "") ++
	...
	"Question_86_Additional_Answers__c" : (payload.Question_86_Additional_Answers__c[0] default "") ++ ";" ++ (payload.Question_86_Additional_Answers__c[1] default "") ++ ";" ++ (payload.Question_86_Additional_Answers__c[2] default "") ++ ";" ++ (payload.Question_84_Additional_Answers__c[3] default ""),
	//"Question_86_Attempted_Suicide_Date__c" : ((payload.Question_84_Attempted_Suicide_Date__c[0] as :date {format : "yyyyMMdd"} as :string {format: "yyyy-MM-dd"} ) default ""), 
	"Q95_Currently_diagnosed_with_ADD_ADHD__c" : flowVars.inputData.QuestionResponses["Mental Health"][10].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Mental Health"][10].Question == "Currently diagnosed with ADD/ADHD:") otherwise "",
	"Question_95_Additional_Answers__c" : ((flowVars.inputData.QuestionResponses["Mental Health"][10].Responses[1].Response default "") ++ ";" ++ (flowVars.inputData.QuestionResponses["Mental Health"][2].Responses[2].Response default ""))
	when (flowVars.inputData.QuestionResponses["Mental Health"][10].Responses[1].Response != null) otherwise "",
	"Q96_MH_counseling_currently_recommended__c" : flowVars.inputData.QuestionResponses["Mental Health"][11].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Mental Health"][11].Question == "Mental health counseling currently recommended (excluding ADD/ADHD treatment):") otherwise "",
	"Question_96_Additional_Answers__c" : flowVars.inputData.QuestionResponses["Mental Health"][11].Responses[1].Response 
	when ( flowVars.inputData.QuestionResponses["Mental Health"][11].Responses[1].Response != null) otherwise "",
	"Q97_MH_medication_currently_prescribed__c" : flowVars.inputData.QuestionResponses["Mental Health"][12].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Mental Health"][12].Question == "Mental health medication currently prescribed (excluding ADD/ADHD medication):") otherwise "",
	"Q85_History_of_MH_concerns__c" : flowVars.inputData.QuestionResponses["Mental Health"][0].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Mental Health"][0].Question == "History of mental health concerns:") otherwise "",
	"Question_85_Additional_Answers__c" : (payload.Question_85_Additional_Answers__c[0] default ""),
	"Q87_History_of_placement_in_MH_RTC__c" : ((flowVars.inputData.QuestionResponses["Mental Health"][2].Responses[0].Response default "") ++ ";" ++ (flowVars.inputData.QuestionResponses["Mental Health"][6].Responses[1].Response default "") ++ ";" ++ (flowVars.inputData.QuestionResponses["Mental Health"][6].Responses[2].Response default ""))
	when (flowVars.inputData.QuestionResponses["Mental Health"][2].Question == "History of placement in a mental health residential treatment facility: ") otherwise "",
	"Q98_Currently_have_health_insurance__c" : flowVars.inputData.QuestionResponses["Mental Health"][13].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Mental Health"][13].Question == "Does youth currently have health insurance?") otherwise "",
	"Question_98_Additional_Answers__c" : flowVars.inputData.QuestionResponses["Mental Health"][13].Responses[1].Response 
	when ( flowVars.inputData.QuestionResponses["Mental Health"][13].Responses[1].Response != null) otherwise "",
	"Q88_History_of_violence_physical_abuse__c" : ((flowVars.inputData.QuestionResponses["Mental Health"][3].Responses[0].Response default "") ++ ";" ++ (flowVars.inputData.QuestionResponses["Mental Health"][3].Responses[1].Response default "") ++ ";" ++ (flowVars.inputData.QuestionResponses["Mental Health"][3].Responses[2].Response default "") ++ ";" ++ (flowVars.inputData.QuestionResponses["Mental Health"][3].Responses[3].Response default "") ++ ";" ++ (flowVars.inputData.QuestionResponses["Mental Health"][3].Responses[4].Response default "") ++ ";" ++ (flowVars.inputData.QuestionResponses["Mental Health"][3].Responses[5].Response default "") ++ ";" ++ (flowVars.inputData.QuestionResponses["Mental Health"][3].Responses[6].Response default "") ) 
	when (flowVars.inputData.QuestionResponses["Mental Health"][3].Question == "History of violence/physical abuse: ") otherwise "",
	"Q89_History_of_witnessing_violence__c" : ((flowVars.inputData.QuestionResponses["Mental Health"][4].Responses[0].Response default "") ++ ";" ++ (flowVars.inputData.QuestionResponses["Mental Health"][4].Responses[1].Response default "") ++ ";" ++ (flowVars.inputData.QuestionResponses["Mental Health"][4].Responses[2].Response default "") ++ ";" ++ (flowVars.inputData.QuestionResponses["Mental Health"][4].Responses[3].Response default "") ++ ";" ++ (flowVars.inputData.QuestionResponses["Mental Health"][4].Responses[4].Response default "") ++ ";" ++ (flowVars.inputData.QuestionResponses["Mental Health"][4].Responses[5].Response default "") ++ ";" ++ (flowVars.inputData.QuestionResponses["Mental Health"][4].Responses[6].Response default "")) 
	when (flowVars.inputData.QuestionResponses["Mental Health"][4].Question == "History of witnessing violence: ") otherwise "",
	"Q90_History_of_sexual_abuse_rape__c" : ((flowVars.inputData.QuestionResponses["Mental Health"][5].Responses[0].Response default "") ++ ";" ++ (flowVars.inputData.QuestionResponses["Mental Health"][5].Responses[1].Response default "") ++ ";" ++ (flowVars.inputData.QuestionResponses["Mental Health"][5].Responses[2].Response default "") ++ ";" ++ (flowVars.inputData.QuestionResponses["Mental Health"][5].Responses[3].Response default "") ++ ";" ++ (flowVars.inputData.QuestionResponses["Mental Health"][5].Responses[4].Response default "") ++ ";" ++ (flowVars.inputData.QuestionResponses["Mental Health"][5].Responses[5].Response default "")) 
	when (flowVars.inputData.QuestionResponses["Mental Health"][5].Question == "History of sexual abuse/rape: ") otherwise "",
	"Q91_History_of_depression_anxiety__c" : flowVars.inputData.QuestionResponses["Mental Health"][6].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Mental Health"][6].Question == "History of depression/anxiety:") otherwise "",
	"Q92_History_of_thought_disturbance__c" : flowVars.inputData.QuestionResponses["Mental Health"][7].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Mental Health"][7].Question == "History of thought disturbance:") otherwise "",
	"Q93_History_of_traumatic_experience__c" : flowVars.inputData.QuestionResponses["Mental Health"][8].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Mental Health"][8].Question == "History of traumatic experience:") otherwise "",
	"Q99_Main_emotion_during_delinquent_acts__c" : flowVars.inputData.QuestionResponses["Attitudes & Behaviors"][0].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Attitudes & Behaviors"][0].Question == "Primary emotion when committing acts of delinquency:") otherwise "",
	"Q100_Main_reason_for_delinquent_acts_6mo__c" : flowVars.inputData.QuestionResponses["Attitudes & Behaviors"][1].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Attitudes & Behaviors"][1].Question == "Primary purpose for committing acts of delinquency within the last 6 months:") otherwise "",
	"Question_100_Additional_Answers__c" : flowVars.inputData.QuestionResponses["Attitudes & Behaviors"][1].Responses[1].Response 
	when (flowVars.inputData.QuestionResponses["Attitudes & Behaviors"][1].Responses[1].Response != null) otherwise "",
	"Q101_Level_of_optimism__c" : flowVars.inputData.QuestionResponses["Attitudes & Behaviors"][2].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Attitudes & Behaviors"][2].Question == "Level of optimism:") otherwise "",
	"Q102_Level_of_impulsiveness__c" : flowVars.inputData.QuestionResponses["Attitudes & Behaviors"][3].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Attitudes & Behaviors"][3].Question == "Level of impulsiveness:") otherwise "",
	"Q103_Control_of_anti_social_behavior__c" : flowVars.inputData.QuestionResponses["Attitudes & Behaviors"][4].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Attitudes & Behaviors"][4].Question == "Belief in control over anti-social behavior:") otherwise "",
	"Q104_Empathy_for_victim_of_delinquency__c" : flowVars.inputData.QuestionResponses["Attitudes & Behaviors"][5].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Attitudes & Behaviors"][5].Question == "Empathy, remorse, sympathy, or feelings for the victim(s) of delinquent behavior:") otherwise "",
	"Q105_Respect_for_property_of_others__c" : flowVars.inputData.QuestionResponses["Attitudes & Behaviors"][6].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Attitudes & Behaviors"][6].Question == "Respect for property of others:") otherwise "",
	"Q106_Respect_for_authority_figures__c" : flowVars.inputData.QuestionResponses["Attitudes & Behaviors"][7].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Attitudes & Behaviors"][7].Question == "Respect for authority figures:") otherwise "",
	"Q107_Youth_belief_laws_apply_to_them__c" : flowVars.inputData.QuestionResponses["Attitudes & Behaviors"][8].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Attitudes & Behaviors"][8].Question == "Attitude toward responsible law abiding behavior:") otherwise "",
	"Q108_Tasks_assigned__c" : flowVars.inputData.QuestionResponses["Attitudes & Behaviors"][9].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Attitudes & Behaviors"][9].Question == "Tasks assigned (include any supervised tasks or jobs):") otherwise "",
	"Q109_Behavior_related_to_assigned_tasks__c" : flowVars.inputData.QuestionResponses["Attitudes & Behaviors"][10].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Attitudes & Behaviors"][10].Question == "Behavior related to assigned tasks:") otherwise "",
	"Q110_Anti_social_behavior_responsibility__c" : flowVars.inputData.QuestionResponses["Attitudes & Behaviors"][11].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Attitudes & Behaviors"][11].Question == "Accepts responsibility for anti-social behavior:") otherwise "",	
	"Q111_Belief_in_meeting_conditions__c" : flowVars.inputData.QuestionResponses["Attitudes & Behaviors"][12].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Attitudes & Behaviors"][12].Question == "Youth's belief in successfully meeting conditions of court supervision:") otherwise "",
	"Question_111_Additional_Answers__c" : flowVars.inputData.QuestionResponses["Attitudes & Behaviors"][12].Responses[1].Response 
	when (flowVars.inputData.QuestionResponses["Attitudes & Behaviors"][12].Responses[1].Response != null) otherwise "",
	"Q112_Tolerance_for_frustration__c" : flowVars.inputData.QuestionResponses["Aggression"][0].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Aggression"][0].Question == "Tolerance for frustration:") otherwise "",
	"Q113_Perception_of_intentions_of_others__c" : flowVars.inputData.QuestionResponses["Aggression"][1].Responses[0].Response 
	...
	"Q114_Belief_in_verbal_aggression__c" : flowVars.inputData.QuestionResponses["Aggression"][2].Responses[0].Response 
	...
	"Q115_Belief_in_physical_aggression__c" : flowVars.inputData.QuestionResponses["Aggression"][3].Responses[0].Response 
	...
	"Q116_Reports_of_violence__c" : (("No reports or evidence of violence;" when (flowVars.inputData.QuestionResponses["Aggression"][4].Responses map $.Response contains ("No reports or evidence of violence")) otherwise "") ++  
	...
	"Question_116_Additional__c" : (payload.Question_116_Additional_Answers__c[0] default "") , 
	"Q117_Displays_consequential_thinking__c" : flowVars.inputData.QuestionResponses["Skills"][0].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Skills"][0].Question == "Does the youth display consequential thinking?") otherwise "",
	"Q118_Practices_goal_setting__c" : flowVars.inputData.QuestionResponses["Skills"][1].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Skills"][1].Question == "Does the youth practice goal setting?") otherwise "",
	"Q119_Displays_problem_solving_behaviors__c" : flowVars.inputData.QuestionResponses["Skills"][2].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Skills"][2].Question == "Does the youth display problem-solving behaviors?") otherwise "",
	"Q120_Use_of_pro_social_skills__c" : flowVars.inputData.QuestionResponses["Skills"][3].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Skills"][3].Question == "Can the youth determine when to use prosocial skills and which skill to use?") otherwise "",
	"Q121_Social_skills_dealing_w_others__c" : flowVars.inputData.QuestionResponses["Skills"][4].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Skills"][4].Question == "How does the youth deal with others?") otherwise "",
	"Q122_Ability_to_deal_w_hard_situations__c" : flowVars.inputData.QuestionResponses["Skills"][5].Responses[0].Response 
	when (flowVars.inputData.QuestionResponses["Skills"][5].Question == "How does the youth deal with difficult situations?") otherwise "",
	"Q123_Youth_monitors_internal_triggers__c" : flowVars.inputData.QuestionResponses["Skills"][6].Responses[0].Response 
	...
	"Q124_Youth_monitors_external_triggers__c" : flowVars.inputData.QuestionResponses["Skills"][7].Responses[0].Response 
	...
	"Q125_Level_of_control_over_impulsiveness__c" : flowVars.inputData.QuestionResponses["Skills"][8].Responses[0].Response 
	...
	"Q126_Alternatives_to_aggression_use__c" : flowVars.inputData.QuestionResponses["Skills"][9].Responses[0].Response 
